                ...
                <div class="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
                    ...
                    <div class="bg-dark_grey border border-dark_border rounded-2xl shadow-cause-shadow p-6 text-white">
                        ...
                        <p class="text-muted text-sm mb-4 text-left">
                            Select a CSV (columns <span class="text-grey font-mono text-xs">phone_number</span>, <span class="text-grey font-mono text-xs">service</span> or <span class="text-grey font-mono text-xs">network</span>, <span class="text-grey font-mono text-xs">amount</span> — same as the sample). The file is imported on the server for reliable large uploads.
                        </p>
